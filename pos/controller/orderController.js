...
import {OderAPI} from "../db/OderAPI.js"
import {CustomerAPI} from "../db/CustomerAPI.js"



const oderAPI = new OderAPI();
const customer_api = new CustomerAPI();
...
function generateOrderId(){
   oderAPI.generateOderID().then((OderId) =>{
       order_id.val(JSON.parse(OderId));
    }).catch((error)=>{
